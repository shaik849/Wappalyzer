...
const getLighthouseMobileDetail = async (req, res, next) => {
  try{
...
const getLighthouseDesktopDetail = async (req, res, next) => {
  try{
  const url = req.query.url;
...
module.exports = { getLighthouseMobileDetail : getLighthouseMobileDetail, getLighthouseDesktopDetail : getLighthouseDesktopDetail}